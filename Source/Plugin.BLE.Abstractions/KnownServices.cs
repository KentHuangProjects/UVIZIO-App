...
namespace Plugin.BLE.Abstractions
{
    ...
    public static class KnownServices
    {
        ...
        //private static readonly String RFD_GUID = "aba8a706-f28c-11e6-bc64-92361f002671";

        static KnownServices()
        {
            LookupTable = Services.ToDictionary(s => s.Id, s => s);
          //  Guid parsed = Guid.ParseExact(RFD_GUID, "d");

          //  new KnownService("TEST", parsed);
        }
        ...
        private static readonly IList<KnownService> Services = new List<KnownService>()
        {
            ...
            // Automation IO for now... should we change this to a unique ID for UVIZIO hardware/app only??
            // For now this works with external apps too...
            new KnownService("UVIZIO LED Service", Guid.ParseExact("00001815-0000-1000-8000-00805f9b34fb", "d")),
